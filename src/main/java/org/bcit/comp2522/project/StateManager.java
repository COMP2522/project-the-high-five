...
public class StateManager {
  ...
  /**
   * Constructor for StateManager class. Initializes the GameState,
   * DatabaseHandler and Window objects.
   *
  ...
  /**
   * Reads the player's game state from the database and updates the Player
   * and LevelManager objects with the data.
   */
  public void pull() {
