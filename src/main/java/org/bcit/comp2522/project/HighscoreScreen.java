...
public class HighscoreScreen {
  ...
  public HighscoreScreen(Window window) {
    ...
    this.backgroundImage
            = window.loadImage("src/main/java/org/bcit/comp2522/project/asset/BackDrop.png");
  }
  ...
  /**
   * Retrieves highscores from highscores ArrayList
   * and displays them on the highscore screen. Displays user and
