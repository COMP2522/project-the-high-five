...
/**
 * The WinningScreen class reprsents the screen displayed
 * when the layer wins the game. It displays the player's score
...
public class WinningScreen {
  ...
  /**
   * Displays the WinningScreen with the Player's score
   * and prompts the player to enter their name and provides
