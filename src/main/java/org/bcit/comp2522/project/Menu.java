...
/**
 * Displays a menu screen with three buttons for starting a new game,
 * loading a saved game and viewing high scores.
 *
 * @author Cheryl Lau
 * @version 1.0 2023
 */
public class Menu {
  ...
  /**
   * Displays the menu screen with buttons for starting a new game,
   * loading a saved game or viewing high scores.
   */
  public void display() {
