 ...
 * It contains a path, tile map, enemy manager, tower manager,
 * bullet manager, select tower UI, and a number of enemies.
 * It also includes methods to reset the level, set the number of
 * enemies, get the path, window, tile map, enemy manager,
 * bullet manager, select tower UI, and towers. It also includes
 * methods to set and get the time for regular, fast, and boss enemies,
 * as well as methods to increase the time for these
 * types of enemies. The Level class is responsible for
 * initializing, drawing, and resetting the level.
 */
...
public class Level {
  ...
  /**
   * Resets the level by creating a new path,
   * loading the tile map image, creating new enemy, tower, and bullet managers,
   * creating a new tile map, resetting the time for regular,
   * fast, and boss enemies, and creating a new select tower UI.
   */
